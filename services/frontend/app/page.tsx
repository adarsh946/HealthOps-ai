  ...
  return (
    <div className="relative mx-auto mt-14 max-w-5xl animate-rise">
      ...
      <div className="overflow-hidden rounded-xl border border-border bg-card shadow-preview">
        <div className="grid min-h-102.5 grid-cols-1 md:grid-cols-[190px_minmax(0,1fr)]">
      ...
      <header className="sticky top-0 z-50 border-b border-border/80 bg-background/90 shadow-nav backdrop-blur-xl">
        <div className="mx-auto grid h-16 max-w-7xl grid-cols-[minmax(0,1fr)_auto] items-center gap-4 px-5 sm:px-6 lg:grid-cols-[auto_1fr_auto] lg:px-8">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <a
              href="#demo"
              className="hidden h-9 items-center justify-center rounded-md bg-emerald-600 px-4 text-sm font-medium text-white transition hover:bg-emerald-700 sm:inline-flex"
            >
              Request Demo
            </a>
            <Button
          ...
          >
            <div className="mx-auto flex max-w-7xl flex-col gap-1">
              ...
              <a
                href="#demo"
                onClick={() => setMenuOpen(false)}
                className="mt-2 flex h-10 items-center justify-center rounded-md bg-emerald-600 text-sm font-medium text-white sm:hidden"
              >
                Request Demo
              </a>
            </div>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
                <Link
                  href="/login"
                  className="inline-flex h-12 items-center justify-center gap-2 rounded-md bg-emerald-600 px-6 text-sm font-semibold text-white shadow-lg shadow-emerald-500/25 transition hover:bg-emerald-700"
                >
                  View Live Demo <ArrowRight className="h-4 w-4" />
                </Link>
                <a
                  href="https://github.com/adarsh946/HealthOps-ai"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex h-12 items-center justify-center gap-2 rounded-md border border-gray-200 bg-white px-6 text-sm font-semibold text-gray-700 transition hover:border-gray-300 hover:bg-gray-50"
                >
                  <svg
                    viewBox="0 0 24 24"
                    className="h-4 w-4"
        ...
        >
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              <Link
                href="/login"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-md bg-white px-6 text-sm font-semibold text-emerald-600 transition hover:bg-emerald-50"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-md border border-white/40 px-6 text-sm font-semibold text-white transition hover:bg-white/10"
              >
                <svg
                  viewBox="0 0 24 24"
                  className="h-4 w-4"
            ...
            <Accordion className="border-t border-border">
              {faqs.map((faq, index) => (
                <AccordionItem key={faq.question} value={index}>
                  <AccordionTrigger className="py-5 text-left text-base font-semibold hover:text-emerald-600 hover:no-underline">
                    {faq.question}
                  </AccordionTrigger>
                  <AccordionContent className="pr-8 text-sm leading-7 text-gray-500">
                    {faq.answer}
                  </AccordionContent>
                </AccordionItem>
              ))}
